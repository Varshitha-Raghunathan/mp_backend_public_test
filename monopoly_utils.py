...
#################################################################
class City:
  def __init__(self,country,name,price,rent,h1p,h2p,h3p,hotelprice,h1r,h2r,h3r,hotelrent,id,bought=False,owner=None):
    self.name=name
...
def move(board,player,no,buy_decision):
  if player.skip_turn:
